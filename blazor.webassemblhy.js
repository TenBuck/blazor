(() => {
  ...
  !(function (e) {
    ...
    (e.attachDispatcher = function (e) {
      ...
      (e.jsCallDispatcher = {
        ...
        beginInvokeJSFromDotNet: (e, t, n, r, o) => {
          ...
          e &&
            s.then(
              (t) => w().endInvokeJSFromDotNet(e, !0, O([e, !0, S(t, r)])),
              (t) =>
                w().endInvokeJSFromDotNet(e, !1, JSON.stringify([e, !1, E(t)]))
            );
        },
    ...
    class C {
      constructor(e) {
        ...
        if (r.has(e))
          (this._streamPromise =
            null === (t = r.get(e)) || void 0 === t ? void 0 : t.streamPromise),
            r.delete(e);
        else {
          const t = new A();
  ...
  class w {
    ...
    async dispose() {
      if (null !== this._componentId) {
        await v().invokeMethodAsync("RemoveRootComponent", this._componentId),
  ...
  function N(e, t, n) {
    return A(e, t.eventHandlerId, () =>
      C(e).invokeMethodAsync("DispatchEventAsync", t, n)
    );
  }
  function C(e) {
    const t = E.get(e);
  ...
  class k {
    constructor(e) {
      ...
      (this.eventsCollectionKey = `_blazorEvents_${t}`),
        (this.eventInfoStore = new D(this.onGlobalEvent.bind(this)));
    }
    setListener(e, t, n, r) {
      ...
      for (; o; ) {
        ...
        if (m) {
          ...
          if (
            ...
            if (!a) {
              const n = i(e);
              (s = (null == n ? void 0 : n.createEventArgs)
                ? n.createEventArgs(t)
                : {}),
                (a = !0);
            }
            R.hasOwnProperty(t.type) && t.preventDefault(),
              N(
    ...
    getEventHandlerInfosForElement(e, t) {
      return e.hasOwnProperty(this.eventsCollectionKey)
        ...
        : t
        ? (e[this.eventsCollectionKey] = new B())
        : null;
    }
  }
  ...
  class D {
    ...
    addGlobalListener(e) {
      if (((e = c(e)), this.countByEventName.hasOwnProperty(e)))
  ...
  function x(e, t, n) {
    const r = e;
    if (e instanceof Comment && z(r) && z(r).length > 0)
  ...
  function G(e, t) {
    ...
    t.forEach((e) => {
      (e.moveRangeStart = n[e.fromSiblingIndex]),
        (e.moveRangeEnd = X(e.moveRangeStart));
    }),
      t.forEach((t) => {
  ...
  class se {
    ...
    updateComponent(e, t, n, r) {
      ...
      this.applyEdits(e, t, s, 0, n, r),
        c instanceof HTMLElement && i && i.activeElement !== c && c.focus();
    }
    disposeComponent(e) {
      ...
      switch (l) {
        ...
        case n.elementReferenceCapture:
          if (r instanceof Element)
            return (
              (u = r),
              (d = c.elementReferenceCaptureId(a)),
              u.setAttribute(q(d), ""),
              0
            );
          throw new Error(
    ...
    insertElement(e, t, r, o, s, a, i) {
      ...
      f || x(u, r, o),
        u instanceof HTMLOptionElement
          ? this.trySetSelectValueFromOptionElement(u)
          : Z in u && ue(u, u._blazorDeferredValue);
    }
    ...
    insertMarkup(e, t, n, r) {
      const o = P(t, n),
        s =
          ((a = e.frameReader.markupContent(r)),
          U(t)
            ? ((ee.innerHTML = a || " "), ee)
            : ((Q.innerHTML = a || " "), Q.content));
      var a;
      let i = 0;
    ...
    applyAttribute(e, t, n, r) {
      ...
      if (a) {
        ...
        this.tryApplySpecialProperty(e, n, s, r) ||
          n.setAttribute(s, o.attributeValue(r));
    }
    tryApplySpecialProperty(e, t, n, r) {
      switch (n) {
        ...
        default:
          return (
            !!n.startsWith(ne) &&
            (this.applyInternalAttribute(e, t, n.substring(ne.length), r), !0)
          );
      }
    }
      ...
      switch (
        (o &&
          ...
          (o = (function (e, t) {
            switch (t) {
              case "time":
                return 8 === e.length && e.endsWith("00")
                  ? e.substring(0, 5)
                  : e;
              case "datetime-local":
                return 19 === e.length && e.endsWith("00")
                  ? e.substring(0, 16)
                  : e;
              default:
                return e;
        ...
        case "TEXTAREA":
          return (
            o && t instanceof HTMLSelectElement && ce(t) && (o = JSON.parse(o)),
            ue(t, o),
  ...
  const ge = {
    listenForNavigationEvents: function (e) {
      (ye = e),
        pe || ((pe = !0), window.addEventListener("popstate", () => ve(!1)));
    },
      ...
      toImageFile: async function (e, t, n, r, o) {
        const s = De(e, t),
          ...
          i = await new Promise(function (e) {
            ...
            (l.width = Math.round(a.width * c)),
              (l.height = Math.round(a.height * c)),
              null === (t = l.getContext("2d")) ||
                void 0 === t ||
                t.drawImage(a, 0, 0, l.width, l.height),
              l.toBlob(e, n);
          }),
          c = {
    ...
    Fe = {
      ...
      _internal: {
        ...
        receiveDotNetDataStream: function (t, n, r, o) {
          ...
          o
            ? (s.error(o), Be.delete(t))
            : 0 === r
            ? (s.close(), Be.delete(t))
            : s.enqueue(n.length === r ? n : n.subarray(0, r));
        },
      ...
      const n =
        ...
        r =
          n instanceof Promise
            ? await n
            : await a(null != n ? n : "_framework/blazor.boot.json"),
        o = t || r.headers.get("Blazor-Environment") || "Production",
        s = await r.json();
      return (
        (s.modifiableAssemblies = r.headers.get(
          "DOTNET-MODIFIABLE-ASSEMBLIES"
        )),
        (s.aspnetCoreBrowserTools = r.headers.get("ASPNETCORE-BROWSER-TOOLS")),
        new Je(s, o)
      );
      async function a(e) {
        return fetch(e, {
  ...
  const Xe = {
              ...
              (window.__wasmmodulecallback__ = () => {
                (window.Module = (function (t, n, r) {
                  const o = t.bootConfig.resources,
                    s = window.Module || {},
                    a = ["DEBUGGING ENABLED"];
                  (s.print = (e) => a.indexOf(e) < 0 && console.log(e)),
                    (s.printErr = (e) => {
                      console.error(e), $e();
                    }),
                    (s.preRun = s.preRun || []),
                  ...
                  const i = "dotnet.wasm",
                    ...
                    u = t.loadResource(
                      ...
                      t.bootConfig.resources.runtime["dotnet.wasm"],
                      "dotnetwasm"
                    ),
                    d = "dotnet.timezones.blat";
                  let f, m;
                  if (
                    (t.bootConfig.resources.runtime.hasOwnProperty(d) &&
                      (f = t.loadResource(
                        d,
                        "_framework/dotnet.timezones.blat",
                        t.bootConfig.resources.runtime["dotnet.timezones.blat"],
                        "globalization"
                      )),
                    t.bootConfig.icuDataMode != Ue.Invariant)
                  ) {
                    const e =
                        t.startOptions.applicationCulture ||
                    ...
                    m = t.loadResource(
                      n,
                      `_framework/${n}`,
                      t.bootConfig.resources.runtime[n],
                      "globalization"
                    );
                  }
                  return (
                    (s.instantiateWasm = (e, t) => (
                      (async () => {
                        let n;
                        try {
                          const t = await u;
                    ...
                    s.preRun.push(() => {
                      (ze = cwrap("mono_wasm_add_assembly", null, [
                        "string",
                        "number",
                        "number",
                      ])),
                        ...
                        f &&
                          (async function (e) {
                            ...
                            Module.FS_createPath("/", "usr", !0, !0),
                              Module.FS_createPath("/usr/", "share", !0, !0),
                        ...
                        m &&
                          (async function (e) {
                            ...
                            if (!MONO.mono_wasm_load_icu_data(o))
                              throw new Error("Error loading ICU asset.");
                            removeRunDependency(t);
                          })(m),
                        c.forEach((e) => h(e, et(e.name, ".dll"))),
                        l.forEach((e) => h(e, e.name)),
                        (Fe._internal.dotNetCriticalError = (e) => {
                          ...
                          if (
                            ...
                            return BINDING.js_to_mono_obj(
                              e.then(
                                (e) => (
                                  e.length &&
                                    (Fe._internal.readSatelliteAssemblies =
                                      () => {
                                        const t = BINDING.mono_obj_array_new(
                                          e.length
                                        );
                      ...
                      Fe._internal.getLazyAssemblies = (n) => {
                        ...
                        if (s.length != r.length) {
                          ...
                          throw new Error(
                            `${a.join()} must be marked with 'BlazorWebAssemblyLazyLoad' item group in your project file to allow lazy-loading.`
                          );
                        }
                        let i;
                        if (xe()) {
                          ...
                          e &&
                            (i = Promise.all(
                              n
                                ...
                                .map(async (e) =>
                                  e ? (await e.response).arrayBuffer() : null
                                )
                            ));
                        }
                        const c = Promise.all(
                          s
                            ...
                            .map(async (e) => (await e.response).arrayBuffer())
                        );
                        return BINDING.js_to_mono_obj(
                          Promise.all([c, i]).then(
                            (t) => (
                              ...
                              (e.pdbs = t[1]),
                              e.assemblies.length &&
                                ((Fe._internal.readLazyAssemblies = () => {
                                  const { assemblies: t } = e;
                                  if (!t) return BINDING.mono_obj_array_new(0);
                                  const n = BINDING.mono_obj_array_new(
                                    t.length
                                  );
                                  for (let e = 0; e < t.length; e++) {
                                    const r = t[e];
                                ...
                                (Fe._internal.readLazyPdbs = () => {
                                  const { assemblies: t, pdbs: n } = e;
                                  if (!t) return BINDING.mono_obj_array_new(0);
                                  const r = BINDING.mono_obj_array_new(
                                    t.length
                                  );
                                  for (let e = 0; e < t.length; e++) {
                                    const t =
                                    ...
                                    BINDING.mono_obj_array_set(
                                      r,
                                      e,
                                      BINDING.js_typed_array_to_array(t)
                                    );
                                  }
                                  return r;
                                })),
                    ...
                    s.postRun.push(() => {
                      t.bootConfig.debugBuild &&
                        t.bootConfig.cacheBootResources &&
                        t.logToConsole(),
                        t.purgeUnusedCacheEntriesAsync(),
                        t.bootConfig.icuDataMode === Ue.Sharded &&
                          (MONO.mono_wasm_setenv("__BLAZOR_SHARDED_ICU", "1"),
                          t.startOptions.applicationCulture &&
                            MONO.mono_wasm_setenv(
                              "LANG",
                              `${t.startOptions.applicationCulture}.UTF-8`
                            ));
                      let r = "UTC";
                      try {
                        r = Intl.DateTimeFormat().resolvedOptions().timeZone;
                      } catch {}
                      MONO.mono_wasm_setenv("TZ", r || "UTC"),
                        t.bootConfig.modifiableAssemblies &&
                          MONO.mono_wasm_setenv(
                            "DOTNET_MODIFIABLE_ASSEMBLIES",
                            t.bootConfig.modifiableAssemblies
                          ),
                        t.bootConfig.aspnetCoreBrowserTools &&
                          MONO.mono_wasm_setenv(
                        ...
                        (function () {
                          ...
                          e.attachDispatcher({
                            ...
                            invokeDotNetFromJS: (e, n, r, o) => (
                              tt(), t(e || null, n, r ? r.toString() : null, o)
                            ),
                          });
                        })(),
                        n();
                  ...
                  async function h(e, t) {
                    ...
                    try {
                      ...
                      new Uint8Array(Module.HEAPU8.buffer, s, r.length).set(r),
                        ze(t, s, r.length),
                        MONO.loaded_files.push(
                          ((o = e.url), (Ye.href = o), Ye.href)
                        );
                    } catch (e) {
                      return void r(e);
                    }
                  ...
                  (function (e) {
                    ...
                    const t = Object.keys(
                        e.bootConfig.resources.runtime
                      ).filter(
                        (e) => e.startsWith("dotnet.") && e.endsWith(".js")
                      )[0],
                    ...
                    if (
                      ...
                      if ("string" == typeof s) r.src = s;
                        ...
                        throw new Error(
                          `For a ${o} resource, custom loaders must supply a URI string.`
                        );
                    }
      ...
      readStringField: function (e, t, n) {
        ...
        return (
          Ke
            ? ((o = Ke.stringCache.get(r)),
              void 0 === o &&
                ((o = BINDING.conv_string(r)), Ke.stringCache.set(r, o)))
            : (o = BINDING.conv_string(r)),
          o
        );
      },
  ...
  class rt {
    constructor(e) {
      (this.batchAddress = e),
        (this.arrayRangeReader = ot),
        (this.arrayBuilderSegmentReader = st),
        (this.diffReader = at),
        (this.editReader = it),
        (this.frameReader = ct);
    }
  ...
  class ut {
    ...
    static async initAsync(e, t) {
      const n = await (async function (e) {
        ...
        const t = `blazor-resources-${document.baseURI.substring(
    ...
    async loadResourceWithCaching(e, t, n, r, o) {
      ...
      if (a) {
        ...
        return (this.cacheLoads[t] = { responseBytes: e }), a;
      }
      {
    ...
    async addToCacheAsync(e, t, n, r) {
      ...
      this.networkLoads[t] = { responseBytes: a };
  ...
  class mt {
    static async initAsync(e) {
      Fe._internal.getApplicationEnvironment = () =>
        BINDING.js_string_to_mono_string(e.applicationEnvironment);
      const t = await Promise.all(
        (e.bootConfig.config || [])
          ...
          .map(async (e) => ({ name: e, content: await n(e) }))
      );
      async function n(e) {
    ...
    if (n && n.nodeType === Node.COMMENT_NODE && n.textContent) {
      ...
      try {
        ...
        switch (t) {
          ...
          case "server":
            return (function (e, t, n) {
              const { type: r, descriptor: o, sequence: s, prerenderId: a } = e;
              if ("server" === r) {
                if (!o)
                  throw new Error(
                ...
                if (!Number.isInteger(s))
                  throw new Error(
                    `Error parsing the sequence '${s}' for component '${JSON.stringify(
                      e
                    )}'`
                  );
                if (a) {
                ...
                return { type: r, sequence: s, descriptor: o, start: t };
              }
            })(r, n, e);
        }
      } catch (e) {
  ...
  async function At(t) {
    ...
    (Ct = !0),
      (function () {
        if (window.parent !== window && !window.opener && window.frameElement) {
          const e =
            ...
            t = e && JSON.parse(e);
          return (
            t && t.redirect_uri && location.href.startsWith(t.redirect_uri)
          );
        }
        return !1;
      })() && (await new Promise(() => {})),
      (A = (e, t, n) => {
        (function (e) {
          return de[e];
        })(e).eventDelegator.getHandler(t) && Xe.invokeWhenHeapUnlocked(n);
      }),
      ...
      (Fe._internal.getApplyUpdateCapabilities = () =>
        e.invokeMethod(
          "Microsoft.AspNetCore.Components.WebAssembly",
          "GetApplyUpdateCapabilities"
        )),
      (Fe._internal.invokeJSFromDotNet = St),
      (Fe._internal.endInvokeDotNetFromJS = Rt),
      (Fe._internal.receiveByteArray = Ot),
      (Fe._internal.retrieveByteArray = kt);
    const n = Me(Xe);
    (Fe.platform = n),
      (Fe._internal.renderBatch = (e, t) => {
    ...
    (Fe._internal.navigationManager.getUnmarshalledBaseURI = () =>
      BINDING.js_string_to_mono_string(r())),
      (Fe._internal.navigationManager.getUnmarshalledLocationHref = () =>
        BINDING.js_string_to_mono_string(o())),
      Fe._internal.navigationManager.listenForNavigationEvents(async (t, n) => {
        await e.invokeMethodAsync(
          "Microsoft.AspNetCore.Components.WebAssembly",
    ...
    (Fe._internal.registeredComponents = {
      ...
      getParameterDefinitions: (e) =>
        BINDING.js_string_to_mono_string(l.getParameterDefinitions(e) || ""),
      getParameterValues: (e) =>
        BINDING.js_string_to_mono_string(l.getParameterValues(e) || ""),
    }),
      (Fe._internal.getPersistedState = () =>
        BINDING.js_string_to_mono_string(yt(document) || "")),
      (Fe._internal.attachRootComponentToElement = (e, t, n) => {
        ...
        r
          ...
          : (function (e, t, n) {
              ...
              else if (e.endsWith("::before"))
                throw new Error("The '::before' selector is not supported.");
              const s =
                (function (e) {
                  const t = m.get(e);
    ...
    const u = await i,
      d = await (async function (e, t) {
        ...
        return (
          n &&
            (await r.importInitializersAsync(Object.keys(n), [
              t,
              e.resources.extensions,
            ])),
          r
        );
      })(u.bootConfig, s),
      [f] = await Promise.all([
        ut.initAsync(u.bootConfig, s || {}),
        mt.initAsync(u),
      ]);
    try {
      await n.start(f);
    ...
    n.callEntryPoint(f.bootConfig.entryAssembly),
      d.invokeAfterStartedCallbacks(Fe);
  }
  function St(t, n, r, o) {
    ...
    if (null !== i) {
      ...
      if (0 !== n)
        return e.jsCallDispatcher.beginInvokeJSFromDotNet(n, s, i, a, c), 0;
      {
